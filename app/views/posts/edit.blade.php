...
@section('content')
	...
	{{ Form::model($post, array('action' => array('PostsController@update', $post->id), 'files'=>true, 'class'=>'span12', 'id'=>'postForm', 'role'=>'form', 'method'=>'PUT')) }}
		...
		<div class="form-group">
			<div class="panel panel-default">
				...
				<textarea class="input-block-level summernote" id="summernote1" name="intro" rows="10">{{{ Form::getValueAttribute('intro', null) }}}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="panel panel-default">
				...
				<textarea class="input-block-level summernote" id="summernote2" name="body" rows="10">{{{ Form::getValueAttribute('body', null) }}}</textarea>
			</div>
		</div>
