...
@section('content')
	...
	{{ Form::model($work, array('action' => array('WorksController@update', $work->id), 'class'=>'span12', 'id'=>'postForm', 'role'=>'form', 'method'=>'PUT')) }}
		...
		<div class="form-group">
			<div class="panel panel-default">
				...
				<input type="text" class="form-control" name="title" value="{{{ Form::getValueAttribute('title', null) }}}" />
			</div>
		</div>
		...
		<div class="form-group">
			<div class="panel panel-default">
				...
				<textarea class="input-block-level summernote" id="summernote1" name="sm_description" >{{{ Form::getValueAttribute('sm_description', null) }}}</textarea>
			</div>
		</div>
		...
		----	Images module
		--->
		@include('works.modules.images', array('img_order'=> Form::getValueAttribute('img_order', null),'images'=>$images))
		...
		----	Featured module
		--->
		@include('works.modules.featured', array('featured_filepath'=> Form::getValueAttribute('featured_filepath', null), 'featured'=> Form::getValueAttribute('featured', null)))
		...
		<div class="row">				
			...
			<div class="col-xs-5 col-sm-3 col-sm-offset-2">
				<button type="submit" value="Store" class="btn btn-primary btn-block">Save Changes</button>
			</div>
		</div>
